...
class AvisoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->data_publicacao !== null) {
            $request->merge(['data_publicacao' => Carbon::createFromFormat('d/m/Y', $request->data_publicacao)->format('Y-m-d')]);
        }
        
        if ($request->data_expiracao !== null) {
            $request->merge(['data_expiracao' => Carbon::createFromFormat('d/m/Y', $request->data_expiracao)->format('Y-m-d')]);
        }
